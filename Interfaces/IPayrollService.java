...
public interface IPayrollService {
	...
	List<Object> getPayrolls(int month, int year, String accessToken, String timesheetCompliance, String priority, Map<String, Object> timesheets, List<Payroll> payrolls, List<Object> users);
	...
	Boolean excludeForMargin(String accessToken,Long payrollId);
	...
	boolean setPayRollApprovalV2(String accessToken,Long userId, int month, int year,boolean status,String comment);

	Map<String, Object> getPayrollUsersTimesheetV2(String accessToken, List<Object> users, int month, int year);

	List<Object> getPayrollsV2(int month, int year, String accessToken, String timesheetCompliance, String priority,
	...
	Map<String,Object> getBuAppovalCommentV2(Long userId, int month, int year);

	List<Map<String,Object>> getPayrollStatusListV2(String accessToken, int month, int year);
