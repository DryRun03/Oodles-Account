...
import com.oodles.dto.PayRegisterDto;
import com.oodles.repository.payroll.PayRegisterRepository;
import com.oodles.security.JwtValidator;
import com.oodles.service.PayrollService;
...
public class PayRegisterController {
	...
	@RequestMapping(method = RequestMethod.GET, value= UrlMappings.GET_REVISION_GAP)
	public ResponseEntity<Object> getRevisionGap(@RequestHeader("Authorization") String accessToken){
		Map<String, Object> data = payRegisterService.getRevisionGap(accessToken);
